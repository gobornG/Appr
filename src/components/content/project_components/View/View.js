...
class View extends Component {
  ...
  render() {
    ...
    const displayViews = views.map( view => {
        ...
        return <ViewField key={`idea-${index}`} index={index} viewid={view.id} viewName={view.name} imgURL={view.image_url} handleChangeView={this.handleChangeView} submitChangeView={this.submitChangeView}/>
    });
